...
rootpath  = '/n/home08/xiaotaoyang/Projects/Cascadia/tempscratch01/Cascadia'                                     # root path for this data processing
CCFDIR    = os.path.join(rootpath,'CCF')                                    # dir to store CC data
DATADIR   = os.path.join(rootpath,'Raw','2012')                               # dir where noise data is located
...
cc_method   = 'deconv'                                                       # 'xcorr' for pure cross correlation, 'deconv' for deconvolution; FOR "COHERENCY" PLEASE set freq_norm to "rma" and time_norm to "no"
...
exclude_chan = ["BDH","HDH"]        #Added by Xiaotao Yang. Channels in this list will be skipped.
...
step      = 1800                                                             # overlapping between each cc_len (sec)
smooth_N  = 20                                                              # moving window length for time/freq domain normalization if selected (points)

# cross-correlation parameters
maxlag         = 1700                                                        # lags of cross-correlation to save (sec)
