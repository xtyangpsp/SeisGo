...
# paths and filenames
rootpath = '/n/home08/xiaotaoyang/Projects/Cascadia/tempscratch01/Cascadia/Raw'       # roothpath for the project
direc  = os.path.join(rootpath,'2012')                      # where to store the downloaded data
...
lamin,lamax,lomin,lomax= 39.0,52.0,-132.0,-116.0                # regional box: min lat, min lon, max lat, max lon (-114.0)
chan_list = ["BHE","BHN","BHZ","HHE","HHN","HHZ","BH1","BH2","HH1","HH2","HDH","BDH"]                                 # channel if down_list=false (format like "HN?" not work here)
net_list  = ["7D","TA","UW","X9","ZH","CN","IU","XT"] #["7D","X9","TA","XT","UW"]                                              # network list
...
end_date   = ["2012_12_31_23_59_59"]                               # end date of download
            ...
            for ichan in chan_list:
                ...
                try:
                    ...
                    if ichan==chan_list[-1] and dataflag==0:
                        print(inet+'.'+ista+'.'+ichan+': Abort at L126 in S0A due to '+str(e))
